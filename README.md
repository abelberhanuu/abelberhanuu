...
**Why it highlights my data analytics skills**

* Built with **Python + Flask**
* Uses **Pandas** to process structured curriculum/course data
* Applies **rule-based planning logic** to evaluate requirements + prerequisites
...
**Tools:** Git/GitHub, Linux, AWS (EC2/S3), REST APIs
**Concepts:** OOP, **ERP (Enterprise Resource Planning)**, Networking Fundamentals (TCP/IP, DNS), Systems Design
...
* **NSBE (Towson)** — Member + led a GitHub fundamentals workshop
...
* Deployed a network-wide DNS filtering service on Debian Linux
* Integrated with router for automatic filtering across all devices
